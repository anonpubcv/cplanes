...
@dataclass
class Model_Config:
    model_name: str = "Cplane"  # choose from "Cplane", "Cplane_Slim"
...
class Data_Config:
    datadir: str = "./data"
    dataset_name: str = "dnerf" #"neural3D_NDC"  # choose from  dyscene"dnerf", "neural3D_NDC"
...
class Optim_Config:
    ...
    batch_size: int = 2048 #3000 #2048 #4096
    n_iters: int = 2000

# @dataclass
# class Optim_fine_Config:
#     # Learning Rate
#     lr_density_grid: float = 0.0002
#     lr_app_grid: float = 0.0002
#     lr_density_nn: float = 0.0001
#     lr_app_nn: float = 0.0001
...
#     lr_decay_target_ratio: float = 0.1
#     lr_decay_step: int = -1
#     lr_upsample_reset: bool = False

#     batch_size: int = 2048 #2048 #4096
#     n_iters: int = 25000
...
class Config:
    ...
    model_fine:Model_Config = Model_Config()
    data: Data_Config = Data_Config()
    optim: Optim_Config = Optim_Config()
    optim_fine: Optim_fine_Config = Optim_fine_Config()
